...
export default {
  ...
  computed: {
    filas() {
      const rows = [];
      for (let i = 2; i <= 8; i++) rows.push({ id: '100000' + i });
      rows.push({ id: '1000001' });
      return rows;
    }
  },
  methods: {
